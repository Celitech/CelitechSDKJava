package net.celitech.celitechsdk.http.util;

import java.util.*;
import lombok.NonNull;
import net.celitech.celitechsdk.http.HttpMethod;
import net.celitech.celitechsdk.http.ModelConverter;
import net.celitech.celitechsdk.http.serialization.PathSerializationStyle;
import net.celitech.celitechsdk.http.serialization.QuerySerializationStyle;
import net.celitech.celitechsdk.http.serialization.SerializationStyle;
import net.celitech.celitechsdk.http.serialization.Serializer;
