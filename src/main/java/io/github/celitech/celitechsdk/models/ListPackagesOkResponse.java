...
public class ListPackagesOkResponse {
  ...
  public static class ListPackagesOkResponseBuilder {
    ...
    @JsonAnySetter
    public ListPackagesOkResponseBuilder additionalProperties(String key, Object value) {
    ...
    public ListPackagesOkResponse build() {
      ...
      return new ListPackagesOkResponse(packages, afterCursor, additionalProperties$value);
    }
  }
}
