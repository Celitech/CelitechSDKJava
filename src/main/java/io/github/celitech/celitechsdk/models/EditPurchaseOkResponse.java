...
public class EditPurchaseOkResponse {
  ...
  public static class EditPurchaseOkResponseBuilder {
    ...
    public EditPurchaseOkResponseBuilder newStartDate(OffsetDateTime newStartDate) {
      this.newStartDate$set = true;
      this.newStartDate = newStartDate;
      return this;
    }

    public EditPurchaseOkResponseBuilder newEndDate(OffsetDateTime newEndDate) {
    ...
    @JsonAnySetter
    public EditPurchaseOkResponseBuilder additionalProperties(String key, Object value) {
