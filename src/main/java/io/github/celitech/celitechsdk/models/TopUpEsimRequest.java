...
public class TopUpEsimRequest {
  ...
  private JsonNullable<TopUpEsimRequestDuration> duration;
  ...
  @JsonIgnore
  public TopUpEsimRequestDuration getDuration() {
  ...
  public static class TopUpEsimRequestBuilder {
    ...
    private JsonNullable<TopUpEsimRequestDuration> duration = JsonNullable.undefined();

    @JsonProperty("duration")
    public TopUpEsimRequestBuilder duration(TopUpEsimRequestDuration value) {
      if (value == null) {
