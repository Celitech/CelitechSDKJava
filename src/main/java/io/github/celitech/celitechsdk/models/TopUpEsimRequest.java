...
public class TopUpEsimRequest {
  ...
  public static class TopUpEsimRequestBuilder {
    ...
    @JsonProperty("startDate")
    public TopUpEsimRequestBuilder startDate(LocalDate value) {
      if (value == null) {
    ...
    @JsonProperty("endDate")
    public TopUpEsimRequestBuilder endDate(LocalDate value) {
      if (value == null) {
    ...
    @JsonAnySetter
    public TopUpEsimRequestBuilder additionalProperties(String key, Object value) {
