...
public class CreatePurchaseOkResponsePurchase {
  ...
  public static class CreatePurchaseOkResponsePurchaseBuilder {
    ...
    public CreatePurchaseOkResponsePurchaseBuilder startDate(OffsetDateTime startDate) {
      this.startDate$set = true;
      this.startDate = startDate;
      return this;
    }

    public CreatePurchaseOkResponsePurchaseBuilder endDate(OffsetDateTime endDate) {
    ...
    @JsonAnySetter
    public CreatePurchaseOkResponsePurchaseBuilder additionalProperties(String key, Object value) {
